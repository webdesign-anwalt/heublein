      ...
      <div class="inhaltsbereich">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
         		...
         		<div id="post-<?php the_ID(); ?>" <?php post_class('post blog-post'); ?>>
            			<h1 class="blog-post-title bounce animated"><?php the_title(); ?></h1>
           			 <p class="blog-post-meta"><?php the_time( 'F j, Y' ); ?> von <?php the_author_posts_link(); ?> in <?php the_category(', ');?></p>

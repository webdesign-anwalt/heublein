	<?php get_header(); ?>
      <div class="row">
		...
		<h1 class="archive-title"><?php _e( 'Suchergebnisse', 'wpboot' ); ?></h1>
	  ...
	  <p><?php _e( 'Leider hatte Ihre Suche keinen Erfolg. Bitte versuchen Sie einen anderen Suchbegriff.', 'wpboot' ); ?></p>
